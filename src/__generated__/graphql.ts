...
export type Mutation = {
  ...
  completeDiscordGuildJoinQuest: Scalars['Boolean']['output'];
...
export type MutationCompleteDiscordGuildJoinQuestArgs = {
  discordAccessToken: Scalars['String']['input'];
...
export enum QuestPolicyType {
  DiscordGuildJoin = 'DISCORD_GUILD_JOIN',
  Quiz = 'QUIZ',
...
export type CompleteDiscordGuildJoinQuestMutationVariables = Exact<{
  questId: Scalars['String']['input'];
  discordAccessToken: Scalars['String']['input'];
  userId: Scalars['String']['input'];
}>;
...
export type CompleteDiscordGuildJoinQuestMutation = { __typename?: 'Mutation', completeDiscordGuildJoinQuest: boolean };
...
export const CompleteDiscordGuildJoinQuestDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CompleteDiscordGuildJoinQuest"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"questId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"discordAccessToken"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"userId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"completeDiscordGuildJoinQuest"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"questId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"questId"}}},{"kind":"Argument","name":{"kind":"Name","value":"discordAccessToken"},"value":{"kind":"Variable","name":{"kind":"Name","value":"discordAccessToken"}}},{"kind":"Argument","name":{"kind":"Name","value":"userId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"userId"}}}]}]}}]} as unknown as DocumentNode<CompleteDiscordGuildJoinQuestMutation, CompleteDiscordGuildJoinQuestMutationVariables>;
